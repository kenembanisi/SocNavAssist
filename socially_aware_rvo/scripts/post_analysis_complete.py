...
def main(args):
    ...
    with open(summary_dir+'/summary_data.csv', mode='w') as output:
        ...
        dw = csv.DictWriter(output, delimiter=',', fieldnames=['Condition', 'Path Length (in meters)', 'CHC', 'Time to Complete',
                     ...
                     'Time-to-Collision(Avg)', 'Time-to-Collision(Median)', 'Avg Disagreement'])
        dw.writeheader()
        ...
        # participant = "For " + participant_ID
        ...
        for condition in conditions:
            ...
            csv_writer.writerow([ condition, round(results_per_condition['avg_path_length'], 2), round(results_per_condition['avg_heading_diff_norm'], 4),
                                ...
                                round(results_per_condition['avg_min_ttc'], 2), round(results_per_condition['median_min_ttc'], 2 ),

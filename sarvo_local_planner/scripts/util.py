...
# log_directory = os.path.dirname(os.path.abspath(__file__))+'/logs/P06/'
log_directory = os.path.dirname(os.path.abspath(__file__))+'/logs/P06_new/'
...
for filename in os.listdir(log_directory):
    ...
    new_name = trial_ID[0]+'_'+trial_ID[1]+'_'+trial_ID[2]+'_'+trial_ID[3]+'_'+ \
        ...
        trial_ID[9]+'_'+trial_ID[8]+'_'+trial_ID[7]+'_'+trial_ID[10]+'_'+trial_ID[11]

...
def main(args):
    ...
    with open(summary_dir + '/' + store_file, mode='w') as output:
        dw = csv.DictWriter(output, delimiter=',', fieldnames=['Condition', 
                     'Path Length (in meters)', 'STD_Path Length (in meters)',
                     'CHC', 'STD_CHC',
                     'Completion Time', 'STD_Completion Time',
                     'Avg Ped Clearance', 'STD_Avg Ped Clearance', 
                     'Min Ped Clearance', 'STD_Min Ped Clearance', 
                     'Max Ped Clearance', 'STD_Max Ped Clearance', 
                     '% Intimate Intrusions', 'STD_% Intimate Intrusions', 
                     '% Personal Intrusions', 'STD_% Personal Intrusions', 
                     '% Social Intrusions', 'STD_% Social Intrusions', 
                     'Avg Disagreement', 'STD_Avg Disagreement'])
        dw.writeheader()
    ...
    # Path length
    p_val = ttest(path_length_mean, path_length_std, n_samples, n_samples)
    ...
    # Completion time
    p_val = ttest(time_to_complete_mean, time_to_complete_std, n_samples, n_samples)
    ...
    p_val = ttest(avg_ped_clearance_mean, avg_ped_clearance_std, n_samples, n_samples)
    ...
    p_val = ttest(min_ped_clearance_mean, min_ped_clearance_std, n_samples, n_samples)
    ...
    # Percentage Intimate
    p_val = ttest(percentage_intimate_mean, percentage_intimate_std, n_samples, n_samples)
    ...
    # Percentage Personal
    p_val = ttest(percentage_personal_mean, percentage_personal_std, n_samples, n_samples)

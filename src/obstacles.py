...
class ObstacleClass():
    ...
    # Constructor:
    def __init__(self, obstacle_id, obstacle_properties):

        # Assign attributes:
        self.obstacle_id = obstacle_id
        self.bounding_radius = obstacle_properties['radius']
    ...
    def move(self):
        ...
        cmd_vel.linear.x = self.v_pref[0]
        cmd_vel.linear.y = self.v_pref[1]
